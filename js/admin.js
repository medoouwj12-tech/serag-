    ...
    if (form) {
      form.addEventListener('submit', (e) => {
        ...
        const data = {
          ...
          categoryNameEn: categoryVal === 'afnan' ? 'AFNAN Collection' : (categoryVal === 'rasasi' ? 'Rasasi Collection' : (categoryVal === 'faan' ? 'FAAN Collection' : (categoryVal === 'dkhoni' ? 'Dkhoni Collection' : (categoryVal === 'ibraq' ? 'IBRAQ Collection' : (categoryVal === 'almas' ? 'ALMAS Collection' : 'Special Gift Sets'))))),
          categoryNameAr: categoryVal === 'afnan' ? 'قسم أفنان' : (categoryVal === 'rasasi' ? 'قسم الرصاصي' : (categoryVal === 'faan' ? 'قسم FAAN' : (categoryVal === 'dkhoni' ? 'قسم دخوني' : (categoryVal === 'ibraq' ? 'قسم أبرق' : (categoryVal === 'almas' ? 'قسم ألماس' : 'المجموعات الخاصة'))))),
