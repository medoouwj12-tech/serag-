    ...
    if (form) {
      form.addEventListener('submit', (e) => {
        ...
        const data = {
          ...
          categoryNameEn: categoryVal === 'afnan' ? 'AFNAN Collection' : (categoryVal === 'rasasi' ? 'Rasasi Collection' : (categoryVal === 'dkhoni' ? 'Dkhoni Collection' : (categoryVal === 'ibraq' ? 'IBRAQ Collection' : 'Special Gift Sets'))),
          categoryNameAr: categoryVal === 'afnan' ? 'قسم أفنان' : (categoryVal === 'rasasi' ? 'قسم الرصاصي' : (categoryVal === 'dkhoni' ? 'قسم دخوني' : (categoryVal === 'ibraq' ? 'قسم أبرق' : 'المجموعات الخاصة'))),
